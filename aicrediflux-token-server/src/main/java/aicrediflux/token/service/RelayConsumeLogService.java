...
public class RelayConsumeLogService {
    ...
    private String buildOther(RelayInfo relayInfo, Usage usage) {
        ...
        appendDispatchMetadata(relayInfo, other);
    ...
    private void appendDispatchMetadata(RelayInfo relayInfo, Map<String, Object> other) {
        if (relayInfo.getExtraData() == null) {
            return;
        }
        putIfPresent(relayInfo, other, "dispatch_source");
        putIfPresent(relayInfo, other, "dispatch_session_id");
        putIfPresent(relayInfo, other, "dispatch_run_id");
    }

    private void putIfPresent(RelayInfo relayInfo, Map<String, Object> other, String key) {
