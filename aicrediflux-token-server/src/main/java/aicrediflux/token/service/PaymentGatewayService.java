...
import aicrediflux.token.common.UrlValidator;
...
public class PaymentGatewayService {
    ...
    public GatewayLaunchResult createStripeTopup(int userId, StripeTopupRequest request) {
        ...
        String tradeNo = "ref_" + sha1("aicrediflux-ref-" + userId + "-" + System.currentTimeMillis() + "-" + RandomUtil.randomLettersAndNumbers(4));
