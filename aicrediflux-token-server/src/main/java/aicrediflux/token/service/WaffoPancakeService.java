...
import aicrediflux.token.mapper.SubscriptionOrderMapper;
import aicrediflux.token.mapper.TopUpMapper;
import aicrediflux.token.pojo.entity.SubscriptionOrder;
import aicrediflux.token.pojo.entity.TopUp;
import aicrediflux.token.service.payment.waffopancake.client.PemKeyLoader;
import aicrediflux.token.service.payment.waffopancake.client.WaffoPancakeApiClient;
import aicrediflux.token.service.payment.waffopancake.client.WaffoPancakeApiException;
import aicrediflux.token.service.payment.waffopancake.client.WaffoPancakeCheckoutResource;
import aicrediflux.token.service.payment.waffopancake.client.WaffoPancakeGraphqlResource;
import aicrediflux.token.service.payment.waffopancake.client.WaffoPancakeOnetimeProductsResource;
import aicrediflux.token.service.payment.waffopancake.client.WaffoPancakePairException;
import aicrediflux.token.service.payment.waffopancake.client.WaffoPancakeStoresResource;
import aicrediflux.token.service.payment.waffopancake.client.WaffoPancakeWebhookVerifier;
import aicrediflux.token.service.payment.waffopancake.pojo.WaffoPancakeCatalog;
import aicrediflux.token.service.payment.waffopancake.pojo.WaffoPancakeCheckoutSession;
import aicrediflux.token.service.payment.waffopancake.pojo.WaffoPancakeCreateSessionParams;
import aicrediflux.token.service.payment.waffopancake.pojo.WaffoPancakePairResult;
import aicrediflux.token.service.payment.waffopancake.pojo.WaffoPancakeWebhookEvent;
...
public class WaffoPancakeService {
    ...
    public static final String DEFAULT_STORE_NAME = "aicrediflux-store";
    /** 确定性默认商品名 */
    public static final String DEFAULT_PRODUCT_NAME = "aicrediflux-charge-product";
     ...
     * <p>
     * 两步流程：① createStore（aicrediflux-store）→ storeId；② createProduct（aicrediflux-charge-product，
     ...
     * 生成 BuyerIdentity。
     * <p>
     * 格式硬编码：{@code aicrediflux-user-{userId}}。webhook 二次校验硬编码此格式，
     * 修改格式会导致 webhook 校验失效（RFC §八.2）。
     */
    public static String buyerIdentityFromUserId(int userId) {
        return "aicrediflux-user-" + userId;
    }
