...
import aicrediflux.token.config.operation.CheckinSettingConfig;
import aicrediflux.token.mapper.CheckinMapper;
import aicrediflux.token.mapper.LogMapper;
import aicrediflux.token.mapper.UserMapper;
import aicrediflux.token.pojo.entity.Checkin;
