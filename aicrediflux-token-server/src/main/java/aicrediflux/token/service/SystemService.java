...
import aicrediflux.token.mapper.MidjourneyMapper;
...
public class SystemService {
    ...
    public String getOptionValue(String key) {
        aicrediflux.token.constant.CommonConstants.optionMapLock.readLock().lock();
        try {
            if (aicrediflux.token.constant.CommonConstants.optionMap == null) {
                return null;
            }
            return aicrediflux.token.constant.CommonConstants.optionMap.get(key);
        } finally {
            aicrediflux.token.constant.CommonConstants.optionMapLock.readLock().unlock();
        }
    }
