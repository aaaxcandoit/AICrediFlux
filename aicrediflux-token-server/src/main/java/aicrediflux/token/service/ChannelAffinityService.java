...
public final class ChannelAffinityService {
    ...
    private static final String CACHE_NAMESPACE = "aicrediflux:channel_affinity:v1";
    private static final String USAGE_CACHE_NAMESPACE = "aicrediflux:channel_affinity_usage_cache_stats:v1";
