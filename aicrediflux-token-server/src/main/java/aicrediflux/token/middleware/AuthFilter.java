...
import aicrediflux.token.config.PublicPaths;
 ...
 * <li>aicrediflux-user-id Header 一致性校验（跨服务调用时验证用户身份一致性）</li>
...
public class AuthFilter implements jakarta.servlet.Filter {
    ...
    public void doFilter(jakarta.servlet.ServletRequest servletRequest,
        ...
        // 3. aicrediflux-user-id Header 校验（可选，用于跨服务调用时验证用户身份一致性）
        String apiUserIdStr = request.getHeader("aicrediflux-user-id");
