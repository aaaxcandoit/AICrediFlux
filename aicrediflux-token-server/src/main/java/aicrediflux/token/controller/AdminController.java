...
import aicrediflux.token.pojo.ipo.AdminIPO;
import aicrediflux.token.service.OAuthManagementService;
import aicrediflux.token.service.TopupService;
import aicrediflux.token.service.UserService;
import aicrediflux.token.service.passkey.PasskeyUserService;
...
public class AdminController {
    ...
    public Result<?> twoFaStats() {
        ...
        long enabledUsers = twoFaMapper.selectCount(
            new com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper<aicrediflux.token.pojo.entity.TwoFa>()
                .eq(aicrediflux.token.pojo.entity.TwoFa::getIsEnabled, true));
