...
public class RelayInfo {
    ...
    @Getter @Setter
    private aicrediflux.token.billingexpr.BillingSnapshot tieredBillingSnapshot;
    @Getter @Setter
    private aicrediflux.token.billingexpr.RequestInput billingRequestInput;
    ...
    @Getter @Setter
    private transient aicrediflux.token.pojo.dto.Usage realtimeUsage = new aicrediflux.token.pojo.dto.Usage();

    /** Realtime 当前响应周期待结算 usage */
    @Getter @Setter
    private transient aicrediflux.token.pojo.dto.Usage realtimePendingUsage = new aicrediflux.token.pojo.dto.Usage();
