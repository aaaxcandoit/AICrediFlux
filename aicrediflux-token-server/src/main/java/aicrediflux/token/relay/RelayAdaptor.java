...
import aicrediflux.token.constant.ApiTypeEnum;
import aicrediflux.token.constant.ChannelConstants;
import aicrediflux.token.relay.channel.IAdaptor;
import aicrediflux.token.relay.channel.ali.AliAdaptor;
import aicrediflux.token.relay.channel.aws.AWSAdaptor;
import aicrediflux.token.relay.channel.baidu.BaiduAdaptor;
import aicrediflux.token.relay.channel.baiduv2.BaiduV2Adaptor;
import aicrediflux.token.relay.channel.claude.ClaudeAdaptor;
import aicrediflux.token.relay.channel.cloudflare.CloudflareAdaptor;
import aicrediflux.token.relay.channel.codex.CodexAdaptor;
import aicrediflux.token.relay.channel.cohere.CohereAdaptor;
import aicrediflux.token.relay.channel.coze.CozeAdaptor;
import aicrediflux.token.relay.channel.deepseek.DeepSeekAdaptor;
import aicrediflux.token.relay.channel.dify.DifyAdaptor;
import aicrediflux.token.relay.channel.gemini.GeminiAdaptor;
import aicrediflux.token.relay.channel.jimeng.JimengAdaptor;
import aicrediflux.token.relay.channel.jina.JinaAdaptor;
import aicrediflux.token.relay.channel.minimax.MiniMaxAdaptor;
import aicrediflux.token.relay.channel.mistral.MistralAdaptor;
import aicrediflux.token.relay.channel.mokaai.MokaAIAdaptor;
import aicrediflux.token.relay.channel.moonshot.MoonshotAdaptor;
import aicrediflux.token.relay.channel.ollama.OllamaAdaptor;
import aicrediflux.token.relay.channel.openai.OpenAIAdaptor;
import aicrediflux.token.relay.channel.palm.PalmAdaptor;
import aicrediflux.token.relay.channel.perplexity.PerplexityAdaptor;
import aicrediflux.token.relay.channel.replicate.ReplicateAdaptor;
import aicrediflux.token.relay.channel.siliconflow.SiliconFlowAdaptor;
import aicrediflux.token.relay.channel.submodel.SubmodelAdaptor;
import aicrediflux.token.relay.channel.tencent.TencentAdaptor;
import aicrediflux.token.relay.channel.vertex.VertexAdaptor;
import aicrediflux.token.relay.channel.volcengine.VolcEngineAdaptor;
import aicrediflux.token.relay.channel.xai.XAIAdaptor;
import aicrediflux.token.relay.channel.xinference.XinferenceAdaptor;
import aicrediflux.token.relay.channel.xunfei.XunfeiAdaptor;
import aicrediflux.token.relay.channel.zhipu.ZhipuAdaptor;
import aicrediflux.token.relay.channel.zhipu4v.Zhipu4VAdaptor;
import aicrediflux.token.relay.channel.task.ali.TaskAliAdaptor;
import aicrediflux.token.relay.channel.task.doubao.TaskDoubaoAdaptor;
import aicrediflux.token.relay.channel.task.gemini.TaskGeminiAdaptor;
import aicrediflux.token.relay.channel.task.hailuo.TaskHailuoAdaptor;
import aicrediflux.token.relay.channel.task.jimeng.TaskJimengAdaptor;
import aicrediflux.token.relay.channel.task.kling.TaskKlingAdaptor;
import aicrediflux.token.relay.channel.task.sora.TaskSoraAdaptor;
import aicrediflux.token.relay.channel.task.suno.TaskSunoAdaptor;
import aicrediflux.token.relay.channel.task.vertex.TaskVertexAdaptor;
import aicrediflux.token.relay.channel.task.vidu.TaskViduAdaptor;
