...
import aicrediflux.token.pojo.dto.RerankResponse;
import aicrediflux.token.pojo.dto.RerankResponseResult;
import aicrediflux.token.relay.channel.xinference.XinferenceDTOPlaceholder;
...
public class RerankCommonHandler {    /** 渠道类型：Xinference */
    ...
    public static RelayInfo.Usage rerankHandler(RelayInfo info, HttpResponse<InputStream> resp) throws Exception {
        ...
        if (info.getChannelType() == CHANNEL_TYPE_XINFERENCE) {
            ...
            aicrediflux.token.pojo.dto.Usage dtoUsage = new aicrediflux.token.pojo.dto.Usage();
