...
import java.util.*; @Slf4j public class SubmodelAdaptor extends OpenAIAdaptor {
    ...
    @Override public List<String> getModelList() { return SubmodelConstant.MODEL_LIST; }
    @Override public String getChannelName() { return SubmodelConstant.CHANNEL_NAME; }
}
