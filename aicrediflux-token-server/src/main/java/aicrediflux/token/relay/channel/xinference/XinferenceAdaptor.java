package aicrediflux.token.relay.channel.xinference;
...
import java.util.*; @Slf4j public class XinferenceAdaptor extends OpenAIAdaptor {
    ...
    @Override public List<String> getModelList() { return XinferenceConstant.MODEL_LIST; }
    @Override public String getChannelName() { return XinferenceConstant.CHANNEL_NAME; }
}
