package aicrediflux.token.relay.channel.ali;

import ai.yue.library.base.convert.Convert;
import aicrediflux.token.pojo.dto.RerankRequest;
import aicrediflux.token.relay.channel.ali.AliDTOPlaceholder.AliRerankInput;
import aicrediflux.token.relay.channel.ali.AliDTOPlaceholder.AliRerankParameters;
import aicrediflux.token.relay.channel.ali.AliDTOPlaceholder.AliRerankRequest;
import aicrediflux.token.relay.channel.ali.AliDTOPlaceholder.AliRerankResponse;
import aicrediflux.token.relay.channel.ali.AliDTOPlaceholder.AliUsage;
import aicrediflux.token.relay.common.RelayInfo;
import aicrediflux.token.relay.common.RelayInfo.Usage;
