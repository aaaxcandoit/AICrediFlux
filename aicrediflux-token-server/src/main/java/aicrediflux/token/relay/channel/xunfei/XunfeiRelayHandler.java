package aicrediflux.token.relay.channel.xunfei;

import ai.yue.library.base.convert.Convert;
import lombok.extern.slf4j.Slf4j;
import aicrediflux.token.pojo.dto.GeneralOpenAIRequest;
import aicrediflux.token.relay.channel.xunfei.XunfeiDTOPlaceholder.*;
...
public class XunfeiRelayHandler {    /**
    ...
    public static Usage responseXunfei2OpenAI(RelayInfo info, XunfeiChatResponse xunfeiResp) {
        ...
        if (xunfeiResp.getPayload() != null && xunfeiResp.getPayload().getUsage() != null
            ...
            aicrediflux.token.pojo.dto.Usage xunfeiUsage = xunfeiResp.getPayload().getUsage().getText();
