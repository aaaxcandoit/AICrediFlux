...
import java.util.*; @Slf4j public class XunfeiAdaptor extends OpenAIAdaptor {
    ...
    @Override public List<String> getModelList() { return XunfeiConstant.MODEL_LIST; }
    @Override public String getChannelName() { return XunfeiConstant.CHANNEL_NAME; }
}
