...
import java.util.*; @Slf4j public class SiliconFlowAdaptor extends OpenAIAdaptor {
    ...
    @Override public List<String> getModelList() { return SiliconFlowConstant.MODEL_LIST; }
    @Override public String getChannelName() { return SiliconFlowConstant.CHANNEL_NAME; }
}
