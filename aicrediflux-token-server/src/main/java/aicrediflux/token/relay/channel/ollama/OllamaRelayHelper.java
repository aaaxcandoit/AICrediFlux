package aicrediflux.token.relay.channel.ollama;

import ai.yue.library.base.convert.Convert;
import jakarta.servlet.http.HttpServletRequest;
import jakarta.servlet.http.HttpServletResponse;
import lombok.extern.slf4j.Slf4j;
import aicrediflux.token.pojo.dto.CachedFileData;
import aicrediflux.token.pojo.dto.EmbeddingDTO;
import aicrediflux.token.pojo.dto.GeneralOpenAIRequest;
import aicrediflux.token.pojo.dto.GeneralOpenAIRequest.Message;
import aicrediflux.token.pojo.dto.OpenAIResponseDTO;
import aicrediflux.token.pojo.dto.OpenAIResponseDTO.OpenAIEmbeddingResponse;
import aicrediflux.token.pojo.dto.OpenAIResponseDTO.OpenAIEmbeddingResponseItem;
import aicrediflux.token.pojo.dto.Usage;
import aicrediflux.token.relay.common.RelayInfo;
import aicrediflux.token.service.DownloadService;
import aicrediflux.token.service.HttpProxyService;
...
public final class OllamaRelayHelper {
    ...
    public static Usage ollamaEmbeddingHandler(HttpServletRequest request, HttpServletResponse response,
        ...
        // 与返回值 aicrediflux.token.pojo.dto.Usage 不兼容，需手动构造
