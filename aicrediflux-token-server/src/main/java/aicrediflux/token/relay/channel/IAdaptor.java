package aicrediflux.token.relay.channel;
...
public interface IAdaptor {
    ...
    /** 转换 Rerank 请求 */
    Object convertRerankRequest(RelayInfo info, int relayMode, aicrediflux.token.pojo.dto.RerankRequest rerankRequest) throws Exception;
