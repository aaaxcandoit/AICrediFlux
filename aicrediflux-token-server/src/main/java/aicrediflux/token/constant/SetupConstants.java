package aicrediflux.token.constant;
...
public final class SetupConstants {
    ...
    public static final String ENV_INIT_MODE = "AICREDIFLUX_INIT_MODE";

    /** 环境变量：auto 模式 root 用户名 */
    public static final String ENV_INIT_ROOT_USERNAME = "AICREDIFLUX_INIT_ROOT_USERNAME";

    /** 环境变量：auto 模式 root 密码（生产建议预置，避免明文进日志） */
    public static final String ENV_INIT_ROOT_PASSWORD = "AICREDIFLUX_INIT_ROOT_PASSWORD";
