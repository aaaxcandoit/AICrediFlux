package aicrediflux.token.service.payment.waffopancake.client;
...
class WaffoPancakeWebhookVerifierTest {
    ...
    void verify_ValidSignature_TestMode_Success() {
        String body = buildWebhookBody("test", "WAFFO_PANCAKE-1-1718900000-abc123", "aicrediflux-user-1");
    ...
    void verify_ValidSignature_ProdMode_Success() {
        String body = buildWebhookBody("prod", "WAFFO_PANCAKE-2-1718900000-xyz789", "aicrediflux-user-2");
    ...
    void verify_ReplayWindowExceeded_Throws() {
        String body = buildWebhookBody("test", "WAFFO_PANCAKE-1-1718900000-abc", "aicrediflux-user-1");
    ...
    void verify_FutureTimestampExceeded_Throws() {
        String body = buildWebhookBody("test", "WAFFO_PANCAKE-1-x", "aicrediflux-user-1");
    ...
    void verify_ModeKeyMismatch_ProdModeTestKey_Throws() {
        String body = buildWebhookBody("prod", "WAFFO_PANCAKE-1-x", "aicrediflux-user-1");
        String header = signHeader(body, testKeyPair.getPrivate());
    ...
    void verify_MissingModeField_Throws() {
        ...
        String body = "{\"id\":\"evt_1\",\"eventType\":\"order.completed\","
                ...
                + "\"merchantProvidedBuyerIdentity\":\"aicrediflux-user-1\"}}";
        String header = signHeader(body, testKeyPair.getPrivate());
    ...
    void verify_InvalidModeValue_Throws() {
        String body = buildWebhookBody("staging", "WAFFO_PANCAKE-1-x", "aicrediflux-user-1");
        String header = signHeader(body, testKeyPair.getPrivate());
