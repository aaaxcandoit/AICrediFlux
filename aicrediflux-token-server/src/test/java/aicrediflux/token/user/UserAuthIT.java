package aicrediflux.token.user;
 ...
 * 鉴权通过 aicrediflux Header（登录后从响应体取 token），Self 端点位于 UserController（/api/user/self 等）。
 */
...
public class UserAuthIT extends BaseIntegrationTest {
    ...
    // ======================== UC-10~19: Self 操作（aicrediflux Header）========================
