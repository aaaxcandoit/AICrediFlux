...
import aicrediflux.token.factory.ChannelFactory;
 ...
 * 鉴权通过 aicrediflux Header（登录后从响应体取 token）+ aicrediflux-user-id Header。
 */
...
public class ChannelIT extends BaseIntegrationTest {
    ...
    /**
     * POST 请求（带 JSON body + 鉴权头：aicrediflux + aicrediflux-user-id）。
     */
