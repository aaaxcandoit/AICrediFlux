...
- Docs: [TBD] Documentation site not yet deployed
...
**Your current aicrediflux version**

Please fill this in, for example: `v1.0.0`

**Your deployment information**

- Java version: [Please fill in, e.g. `17.0.x`]
- Deployment method: [Please select: Docker / JAR / Source]
...
- [ ] **Read this first:** I have fully read the section above, reviewed the project README, and asked AI first, confirming this is not a usage, configuration, or integration question.
