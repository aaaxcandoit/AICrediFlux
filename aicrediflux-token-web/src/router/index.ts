  ...
  // 原 '' (Home) 子路由已被公开落地页取代，移除后已登录用户访问 / 同样看到落地页
  {
    ...
    children: [
      ...
      },
      {
        path: 'token-mall',
        name: 'TokenMall',
        component: () => import('@/views/token-mall/index.vue'),
        meta: { title: 'nav.tokenMall', requireAuth: true, keepAlive: true }
      },
      {
        path: 'orders/token',
        name: 'TokenOrders',
        component: () => import('@/views/token-orders/index.vue'),
        meta: { title: 'nav.tokenOrders', requireAuth: true, keepAlive: true }
      },
      {
        path: 'admin/token-package',
        name: 'AdminTokenPackage',
        component: () => import('@/views/admin-token-package/index.vue'),
        meta: { title: 'nav.adminTokenPackages', requireAuth: true, roles: ['admin'], keepAlive: true }
      },
      {
        path: 'admin/flash-sale',
        name: 'AdminFlashSale',
        component: () => import('@/views/admin-flash-sale/index.vue'),
        meta: { title: 'nav.adminFlashSale', requireAuth: true, roles: ['admin'], keepAlive: true }
      },
      {
        path: 'admin/rag-knowledge',
        name: 'AdminRagKnowledge',
        component: () => import('@/views/admin-rag-knowledge/index.vue'),
        meta: { title: 'nav.adminRagKnowledge', requireAuth: true, roles: ['admin'], keepAlive: true }
      },
