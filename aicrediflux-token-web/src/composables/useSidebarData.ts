  ...
  const sidebarData = computed<SidebarData>(() => ({
    navGroups: [
      ...
      },
      {
        ...
        items: [
          {
            title: t('nav.aiCredit'),
            icon: SIDEBAR_ICONS.aiCredit,
            items: [
              {
                title: t('nav.tokenMall'),
                url: '/token-mall',
                icon: SIDEBAR_ICONS.tokenMall
              },
              {
                title: t('nav.tokenOrders'),
                url: '/orders/token',
                icon: SIDEBAR_ICONS.tokenOrders
              },
              {
                title: t('nav.wallet'),
                url: '/wallet'
        ...
        ? [
            {
              ...
              items: [
                ...
                {
                  title: t('nav.aiCreditAdmin'),
                  icon: SIDEBAR_ICONS.aiCreditAdmin,
                  items: [
                    {
                      title: t('nav.adminTokenPackages'),
                      url: '/admin/token-package',
                      icon: SIDEBAR_ICONS.adminTokenPackages
                    },
                    {
                      title: t('nav.adminFlashSale'),
                      url: '/admin/flash-sale',
                      icon: SIDEBAR_ICONS.adminFlashSale
                    }
                  ]
                },
                {
                  title: t('nav.adminRagKnowledge'),
                  url: '/admin/rag-knowledge',
                  icon: SIDEBAR_ICONS.adminRagKnowledge
                },
                {
